          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    {...register("slug", {
                      ...
                      validate: (value) =>
                        !/\s/.test(value) ||
                        "El Slug no debe de tener espcios en blanco",
                    })}
                    className={cn(
                      "w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200",
                  ...
                  {errors.slug && (
                    <span className="text-red-500">
                      {errors.slug.message ||
                        "El slug debe tener almenos 5 caracteres"}
                    </span>
                  )}
                </div>
                ...
                {errors.gender && (
                  <span className="text-red-500">Selecciona el genero</span>
                )}
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">
                  ...
                  {errors.description && (
                    <span className="text-red-500">
                      Coloca una descripcion minima de 10 caracteres
                    </span>
                  )}
                </div>
              </div>
                  ...
                  {availableSizes.map((size) => (
                    <span
                      ...
                      className={cn(
                        ...
                        { hidden: !selectetdSizes.includes(size) },
                      )}
                    >
                      {size}
                      <button
                  ...
                  {selectetdTags.map((tag) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="cursor-pointer ml-2 text-green-600 hover:text-red-800 transition-colors duration-200"
                      >
                        <X className="h-3 w-3" />
                      </button>
                    </span>
